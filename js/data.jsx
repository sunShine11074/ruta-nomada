...
const DESTINATIONS = [
  ...
  { name: "Patagonia", country: "Argentina", category: "Aventura", tint: "aventura", icon: "aventura",
    desc: "Naturaleza salvaje en el fin del mundo.", price: "$28,900 MXN", rating: "4.9" },
  { name: "Marruecos", country: "Marrakech", category: "Descubrimiento", tint: "desierto", icon: "desierto",
    desc: "Misticismo y colores vibrantes en el desierto.", price: "$19,500 MXN", rating: "4.7" },
  { name: "Cancún", country: "México", category: "Playa", tint: "agua", icon: "beach",
    desc: "Playas paradisíacas, cultura maya y vida nocturna.", price: "$8,500 MXN", rating: "4.8" },
  { name: "Costa Amalfitana", country: "Italia", category: "Romance", tint: "romance", icon: "romance",
    desc: "Pueblos colgados del mar y limoncello al atardecer.", price: "$33,400 MXN", rating: "4.9" },
  { name: "Bosques de Bavaria", country: "Alemania", category: "Aventura", tint: "bosque", icon: "bosque",
    desc: "Senderos entre niebla, castillos y aire de pino.", price: "$26,100 MXN", rating: "4.6" },
  { name: "Lisboa", country: "Portugal", category: "Cultura", tint: "ciudad", icon: "ciudad",
    desc: "Tranvías, azulejos y miradores sobre el Tajo.", price: "$22,700 MXN", rating: "4.8" },
];
...
Object.assign(window, { DESTINATIONS, CATEGORIES, STORIES, MY_TRIPS });
